...
int main (int argc, char *argv[])
{
    ...
    flowMonitorFilename << id << "-1-large-load-" << LEAF_COUNT << "X" << SPINE_COUNT << "-" << load << "-"  << transportProt <<"-" << aqmStr << "-" << redMarkingThreshold << "-" << CODELTarget << "-" << CODELInterval << "-";
    linkMonitorFilename << id << "-1-large-load-" << LEAF_COUNT << "X" << SPINE_COUNT << "-" << load << "-"  << transportProt <<"-" << aqmStr << "-" << redMarkingThreshold << "-" << CODELTarget << "-" << CODELInterval << "-";
    tlbBibleFilename << id << "-1-large-load-" << LEAF_COUNT << "X" << SPINE_COUNT << "-" << load << "-"  << transportProt <<"-" << aqmStr << "-" << redMarkingThreshold << "-" << CODELTarget << "-" << CODELInterval << "-";
    tlbBibleFilename2 << id << "-1-large-load-" << LEAF_COUNT << "X" << SPINE_COUNT << "-" << load << "-"  << transportProt <<"-" << aqmStr << "-" << redMarkingThreshold << "-" << CODELTarget << "-" << CODELInterval << "-";
    rbTraceFilename << id << "-1-large-load-" << LEAF_COUNT << "X" << SPINE_COUNT << "-" << load << "-"  << transportProt <<"-"  << aqmStr << "-" << redMarkingThreshold << "-" << CODELTarget << "-" << CODELInterval << "-";
